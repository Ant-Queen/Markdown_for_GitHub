...
1. 연결할 코드를 찾습니다.
    ...
    * 끌어오기 요청에서 코드에 연결하려면 끌어오기 요청으로 이동하고  **![alt text](</images/diff.jpg>) 변경된 파일**을 클릭합니다. 그런 다음 주석에 포함할 코드가 포함된 파일을 찾아 **보기**를 클릭합니다.
...
1. 줄의 왼쪽 또는 줄의 범위에서 ![alt text](</images/kebab-horizontal.jpg>)을(를) 클릭합니다. 드롭다운 메뉴에서 **고정 링크 복사**를 클릭합니다.
