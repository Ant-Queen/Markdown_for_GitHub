...
`<details>` 블록 내에서 `<summary>` 태그를 사용하여 판독기 내에 무엇이 있는지 알 수 있습니다. 레이블은 ![alt text](</images/triangle-right.jpg>) 아이콘의 오른쪽에 표시됩니다.
...
사용자가 ![alt text](</images/triangle-right.jpg>) 아이콘을 클릭하면 세부 정보가 확장됩니다.
